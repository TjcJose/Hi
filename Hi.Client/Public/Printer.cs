...
namespace Hi.Client
{
    class Printer
    {
        ...
        internal static PrintPertory GetPrintPertory { get; set; }
...
dmDeviceName;
    ...
    public class PrintPertory
    {
        /// <summary>
        /// 实体类  (属性说明自动提取数据库字段的描述信息)
        /// </summary>
        #region 属性说明自动提取数据库字段的描述信息
        private string _print_name;
        private string _print_direction;
        private string _print_left;
        private string _print_right;
        private string _print_top;
        private string _print_bottom;
        private string _print_pageindex;
        /// <summary>
        /// string
        /// </summary>
        ...
        {
            get { return _print_direction; }
            set { _print_direction = value; }
        }
        ...
        {
            get { return _print_left; }
            set { _print_left = value; }
        }
        ...
        {
            get { return _print_right; }
            set { _print_right = value; }
        }
        ...
        {
            get { return _print_top; }
            set { _print_top = value; }
        }
        ...
        {
            get { return _print_bottom; }
            set { _print_bottom = value; }
        }

        /// <summary>
        /// 自定义纸张序号
        /// </summary>
        public string PrintPageIndex
        {
            get { return _print_pageindex; }
            set { _print_pageindex = value; }
        }
        public string PrintPageWidth { get; set; }
        public string PrintPageHeight { get; set; }
