...
namespace Hi.DAL.Access
{
    ...
    public class SysAdmin : ISysAdmin
    {
        ...
        {
            string strSql = @"select b.title as ptitle,b.code as pcode,a.* from bas_param a ,bas_param b ";
            strSql += " where a.parent_id=b.id ";

            strSql += " order by b.code,a.code  ";
        ...
        {
            string strSql = @"select * from bas_param  ";
            return strSql;
        }
        #endregion 
        ...
        {
            string strSql = @"select b.title as ptitle,a.* from bas_param a ,bas_param b  ";
            strSql += " where a.parent_id=b.id ";
            if (parent_type > 0)
                strSql += " and a.parent_id =" + parent_type.ToString();
            else
                strSql += " and a.parent_id=0";
